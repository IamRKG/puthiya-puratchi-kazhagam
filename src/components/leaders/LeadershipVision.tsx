      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#000066] mb-6">தலைமையின் தொலைநோக்கு</h2>
            <motion.div 
              className="h-1 w-20 bg-[#000066] rounded-full mb-8"
              initial={{ width: 0 }}
            ...
            <div className="space-y-6">
              {visionPoints.map((point, index) => (
                <motion.div
                  ...
                  className="flex items-start p-6 bg-gradient-to-r from-[#000066]/5 to-transparent rounded-xl hover:from-[#000066]/10 transition-all"
                >
                  <div className="text-[#000066] mr-4">{point.icon}</div>
                  <div>
                    <h3 className="text-xl font-bold text-[#000066] mb-2">{point.title}</h3>
                    <p className="text-[#000066]/80">{point.description}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          >
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 p-8 text-white">
                ...
                <p className="text-white/90">- கழகத் தலைவர்</p>
              </div>
            </div>
          </motion.div>
        </div>
